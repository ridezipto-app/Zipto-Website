...
export default function LaunchingSoon() {
  return (
   <div className="min-h-screen bg-gradient-to-br from-blue-600 to-orange-500 text-white flex flex-col items-center justify-center px-6">
      ...
      {/* Cards */}
     <div className="border border-white/20 backdrop-blur-md bg-white/10 rounded-xl p-6 flex items-center gap-4">
