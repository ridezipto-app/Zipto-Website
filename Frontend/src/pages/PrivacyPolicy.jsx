  ...
  },
  {
    ...
    content: (
      <ul className="info-list">
        ...
        <li><span className="label">Email</span><a href="mailto:support@ridezipto.com">support@ridezipto.com</a></li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="contact-chip mt-4">📩 <a href="mailto:support@ridezipto.com">support@ridezipto.com</a></div>
      </>
    ),
  },
  {
      ...
      <div className="contact-grid">
        <div className="contact-card">
          ...
          <div>
            ...
            <a href="mailto:support@ridezipto.com">support@ridezipto.com</a>
          </div>
        </div>
        <div className="contact-card">
          <div className="icon">📍</div>
