    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[500px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg">
            Zipto is a technology-driven logistics platform built to simplify
            and accelerate last-mile delivery for businesses and individuals.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-600 text-lg leading-relaxed text-center max-w-4xl mx-auto">
          Zipto is redefining local delivery with a smart and connected
          logistics network. From bikes to mini trucks, we provide fast,
          reliable, and affordable transportation for businesses and
          individuals. Built on technology and efficiency, Zipto ensures every
          delivery is seamless, on time, and hassle-free.
          <br />
          <br />
      ...
      <div className="py-16 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto text-gray-600">
            <p>
              • Enable faster and more reliable deliveries for businesses and
              individuals
            </p>
            <p>
              • Support local commerce through efficient logistics
              infrastructure
            </p>
            <p>• Create flexible earning opportunities for delivery partners</p>
            <p>
              • Build a scalable logistics ecosystem that supports growing
              cities
            </p>
          </div>
        </div>
              ...
              >
                <div className="text-3xl mb-3">
                  <img
                    src={item.icon}
                    alt={item.title}
                    className="mx-auto mb-3 w-20 h-20 object-contain transition duration-300 hover:scale-110"
                  />
                </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            ...
            <br />
            <br />
            As we grow, our focus remains on building a delivery network that is
